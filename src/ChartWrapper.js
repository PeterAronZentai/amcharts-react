// THIS FILE IS TAKEN FROM THE NPM PACKAGE CALLED @amcharts/amcharts-react
...
// EXTRA HACK
var imagesContext = require.context('!!file-loader?name=images/amcharts/[name].[ext]!amcharts/images', true, /\.(png|jpg|gif|svg)$/);
...
export class AmChart extends Component {
  ...
  componentDidMount() {
    ...
    var chart = window.AmCharts.makeChart(this.state.id, props, this.props.delay);
  ...
  render() {
    return <div id={this.state.id} style={this.props.style} />
  }
}
